...
RESULTS_FILE_RQ5_BASELINE = RESULTS_DIR / "rq5_baseline_results.csv"
RESULTS_FILE_RQ5_SYNTHETIC = RESULTS_DIR / "rq5_synthetic_results.csv"
TEST = RESULTS_DIR / "test.csv"